...
class ImageBuilderTest extends TestCase
{
    ...
    public function testImageBuild()
    {
        ...
        $imageBuilder->build('toto', 'toto.png', 'http://test.com/images/uploads/toto.png');
        ...
        static::assertSame('http://test.com/images/uploads/toto.png', $imageBuilder->getImage()->getPublicUrl());
    }
}
